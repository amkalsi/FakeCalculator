...
// Wed Jan 29 17:47:46 2020 by ROOT version 6.06/01
// from TTree IIHEAnalysis/IIHEAnalysis
// found on file: /pnfs/iihe/cms/store/user/amkalsi/2018_ReReco_DeepTau/WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8/crab_WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8_v1/200117_183346/0000/outfile_1.root
//////////////////////////////////////////////////////////
...
#ifdef CheckInfo_cxx
CheckInfo::CheckInfo(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/pnfs/iihe/cms/store/user/amkalsi/2018_ReReco_DeepTau/WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8/crab_WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8_v1/200117_183346/0000/outfile_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/pnfs/iihe/cms/store/user/amkalsi/2018_ReReco_DeepTau/WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8/crab_WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8_v1/200117_183346/0000/outfile_1.root");
      }
...
Int_t CheckInfo::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CheckInfo::LoadTree(Long64_t entry)
{
...
void CheckInfo::Init(TTree *tree)
{
...
void CheckInfo::Show(Long64_t entry)
{
...
Int_t CheckInfo::Cut(Long64_t entry)
{
