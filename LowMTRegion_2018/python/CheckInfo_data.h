...
// Wed Jan 29 17:48:55 2020 by ROOT version 6.06/01
// from TTree IIHEAnalysis/IIHEAnalysis
// found on file: /pnfs/iihe/cms/store/user/amkalsi/2018_ReReco_DeepTau/EGamma/crab_EGamma_B/200117_200623/0002/outfile_2102.root
//////////////////////////////////////////////////////////

#ifndef CheckInfo_data_h
#define CheckInfo_data_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   CheckInfo_data(TTree *tree=0);
   virtual ~CheckInfo_data();
...
#ifdef CheckInfo_data_cxx
CheckInfo_data::CheckInfo_data(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/pnfs/iihe/cms/store/user/amkalsi/2018_ReReco_DeepTau/EGamma/crab_EGamma_B/200117_200623/0002/outfile_2102.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/pnfs/iihe/cms/store/user/amkalsi/2018_ReReco_DeepTau/EGamma/crab_EGamma_B/200117_200623/0002/outfile_2102.root");
      }
...
CheckInfo_data::~CheckInfo_data()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CheckInfo_data::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CheckInfo_data::LoadTree(Long64_t entry)
{
...
void CheckInfo_data::Init(TTree *tree)
{
...
void CheckInfo_data::Show(Long64_t entry)
{
...
Int_t CheckInfo_data::Cut(Long64_t entry)
{
...
#endif // #ifdef CheckInfo_data_cxx
