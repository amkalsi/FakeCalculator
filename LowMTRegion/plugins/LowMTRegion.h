// -*- C++ -*-
//
// Package:    Plots/LowMTRegion
// Class:      LowMTRegion
// 
/**\class LowMTRegion LowMTRegion.cc Plots/LowMTRegion/plugins/LowMTRegion.cc
...
class LowMTRegion : public edm::EDAnalyzer {
	public:
		explicit LowMTRegion(const edm::ParameterSet&);
		~LowMTRegion();
