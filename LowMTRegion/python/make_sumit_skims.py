...
from datasets_deepTau import * 
if __name__ == "__main__":
    location=os.getcwd();
    #name of your *compiled* code (omit the .exe extension)
    code_area = "/user/amkalsi/CMSSW_8_0_17/src/Plots/LowMTRegion/python/"
    code_name = "MuJetAnalysisBGZ.py"
    folder = "/pnfs/iihe/cms/store/user/amkalsi/Jan2019"
    cms_rel = "/user/amkalsi/CMSSW_8_0_17/src/Plots/LowMTRegion/python/"
