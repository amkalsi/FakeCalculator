...
// Sat Mar 30 18:05:10 2019 by ROOT version 6.06/01
// from TTree IIHEAnalysis/IIHEAnalysis
// found on file: /pnfs/iihe/cms/store/user/amkalsi/2017_MET_Corrected_10Dec2018_v2/SingleElectron/crab_SingleElectron_B/190213_231955/0000/outfile_1.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           trig_HLT_Trimuon2_Upsilon5_Muon_accept;
   ...
   vector<float>   *trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_eta;
   vector<float>   *trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_phi;
   vector<float>   *trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_et;
   ...
   vector<float>   *trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_eta;
   vector<float>   *trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_phi;
   vector<float>   *trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_et;
   ...
   vector<float>   *trig_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_hltL1sSingleAndDoubleEGor_et;
   ...
   vector<float>   *trig_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_hltL1sSingleAndDoubleEGor_et;
   ...
   Int_t           trig_HLT_MediumChargedIsoPFTau100HighPtRelaxedIso_Trk50_eta2p1_1pr_accept;
   ...
   TBranch        *b_trig_HLT_Trimuon2_Upsilon5_Muon_accept;   //!
   ...
   TBranch        *b_trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_eta;   //!
   TBranch        *b_trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_phi;   //!
   TBranch        *b_trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_et;   //!
   ...
   TBranch        *b_trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_eta;   //!
   TBranch        *b_trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_phi;   //!
   TBranch        *b_trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_et;   //!
   ...
   TBranch        *b_trig_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_hltL1sSingleAndDoubleEGor_et;   //!
   ...
   TBranch        *b_trig_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_hltL1sSingleAndDoubleEGor_et;   //!
   ...
   TBranch        *b_trig_HLT_MediumChargedIsoPFTau100HighPtRelaxedIso_Trk50_eta2p1_1pr_accept;   //!
...
#ifdef HHL_cxx
HHL::HHL(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/pnfs/iihe/cms/store/user/amkalsi/2017_MET_Corrected_10Dec2018_v2/SingleElectron/crab_SingleElectron_B/190213_231955/0000/outfile_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/pnfs/iihe/cms/store/user/amkalsi/2017_MET_Corrected_10Dec2018_v2/SingleElectron/crab_SingleElectron_B/190213_231955/0000/outfile_1.root");
      }
...
Int_t HHL::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HHL::LoadTree(Long64_t entry)
{
...
void HHL::Init(TTree *tree)
{
   ...
   trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_eta = 0;
   trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_phi = 0;
   trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_et = 0;
   ...
   trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_eta = 0;
   trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_phi = 0;
   trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_et = 0;
   ...
   trig_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_hltL1sSingleAndDoubleEGor_et = 0;
   ...
   trig_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_hltL1sSingleAndDoubleEGor_et = 0;
   ...
   fChain->SetBranchAddress("trig_HLT_Trimuon2_Upsilon5_Muon_accept", &trig_HLT_Trimuon2_Upsilon5_Muon_accept, &b_trig_HLT_Trimuon2_Upsilon5_Muon_accept);
   ...
   fChain->SetBranchAddress("trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_eta", &trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_eta, &b_trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_eta);
   fChain->SetBranchAddress("trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_phi", &trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_phi, &b_trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_phi);
   fChain->SetBranchAddress("trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_et", &trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_et, &b_trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfChi2Filter_et);
   ...
   fChain->SetBranchAddress("trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_eta", &trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_eta, &b_trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_eta);
   fChain->SetBranchAddress("trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_phi", &trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_phi, &b_trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_phi);
   fChain->SetBranchAddress("trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_et", &trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_et, &b_trig_HLT_Ele32_WPTight_Gsf_L1DoubleEG_hltEle32L1DoubleEGWPTightGsfChi2Filter_et);
   ...
   fChain->SetBranchAddress("trig_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_hltL1sSingleAndDoubleEGor_et", &trig_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_hltL1sSingleAndDoubleEGor_et, &b_trig_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_hltL1sSingleAndDoubleEGor_et);
   ...
   fChain->SetBranchAddress("trig_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_hltL1sSingleAndDoubleEGor_et", &trig_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_hltL1sSingleAndDoubleEGor_et, &b_trig_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_hltL1sSingleAndDoubleEGor_et);
   ...
   fChain->SetBranchAddress("trig_HLT_MediumChargedIsoPFTau100HighPtRelaxedIso_Trk50_eta2p1_1pr_accept", &trig_HLT_MediumChargedIsoPFTau100HighPtRelaxedIso_Trk50_eta2p1_1pr_accept, &b_trig_HLT_MediumChargedIsoPFTau100HighPtRelaxedIso_Trk50_eta2p1_1pr_accept);
